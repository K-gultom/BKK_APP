...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">Data Penerbitan Perizinan</h4>
        <div>
            <a href="{{ url('/admin/penerbitan-perizinan') }}" class="btn btn-outline-secondary me-2">
    ...
    <div class="row mb-3">
        <div class="col-md-4">
            <form method="GET" action="{{ route('admin.penerbitan-perizinan.index') }}">
